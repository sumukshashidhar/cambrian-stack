#!/bin/bash
# Train baseline transformer on TinyStories
...
# Use NVLinked GPUs 0,1 for optimal performance
export CUDA_VISIBLE_DEVICES=${CUDA_VISIBLE_DEVICES:-0,1}
export MAIN_PROCESS_PORT=${MAIN_PROCESS_PORT:-29500}
echo "✓ Using GPUs: $CUDA_VISIBLE_DEVICES (NVLinked pair)"
